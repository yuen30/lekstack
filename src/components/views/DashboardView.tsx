        ...
        <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-[#1a1a1a] p-5 rounded-2xl border border-gray-100 dark:border-gray-800 flex items-center gap-4 transition-all">
                    <div className="w-12 h-12 rounded-xl bg-orange-50 text-orange-600 dark:bg-orange-900/20 dark:text-orange-400 flex items-center justify-center"><Globe size={24} /></div>
                    <div>
                ...
                <div className="bg-white dark:bg-[#1a1a1a] p-5 rounded-2xl border border-gray-100 dark:border-gray-800 flex items-center gap-4 transition-all">
                    <div className="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400 flex items-center justify-center"><Server size={24} /></div>
                    <div>
                        <div className="text-sm text-gray-400 font-medium">Stack Status</div>
                        <div className={`text-2xl font-bold ${services.every(s => s.status === 'running') ? 'text-green-500' : 'text-gray-900 dark:text-white'}`}>
                            {services.filter(s => s.status === 'running').length}/{services.length} Running
                        </div>
                    </div>
                </div>
                <div className="bg-white dark:bg-[#1a1a1a] p-5 rounded-2xl border border-gray-100 dark:border-gray-800 flex items-center gap-4 transition-all">
                    <div className="w-12 h-12 rounded-xl bg-violet-50 text-violet-600 dark:bg-violet-900/20 dark:text-violet-400 flex items-center justify-center"><Database size={24} /></div>
                    <div>
