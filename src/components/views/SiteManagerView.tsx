...
import { FolderPlus, Trash2, ExternalLink, Globe, Folder } from 'lucide-react';
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in zoom-in-95 duration-500">
            ...
            <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-1">Manage your local sites and parked paths</p>
            </div>
                    ...
                    <div className="bg-white dark:bg-[#1a1a1a] p-5 rounded-2xl border border-gray-100 dark:border-gray-800">
                        ...
                        <div className="space-y-2">
                            ...
                            {parkedPaths.map(path => (
                                <div key={path} className="flex justify-between items-center p-3 bg-gray-50 dark:bg-[#111] rounded-lg group">
                                    <span className="text-sm text-gray-600 dark:text-gray-300 truncate" title={path}>{path}</span>
                                    <button
                ...
                <div className="lg:col-span-2">
                    <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
                        ...
                        <div className="divide-y divide-gray-100 dark:divide-gray-800 max-h-[600px] overflow-y-auto">
                            ...
                            {sites.map(site => (
                                <div key={site.path} className="p-4 hover:bg-gray-50 dark:hover:bg-[#222] transition-colors flex items-center justify-between group">
